...
use app\modules\comments\widgets\comments\assets\CommentsAsset;
use app\modules\comments\widgets\comments\assets\CommentsGuestAsset;
...
class Comments extends Widget
{
	...
	public function init()
	{
		...
		if ($this->sendButtonText === null) {
			$this->sendButtonText = Yii::t('app', 'Добавить');
		}
		if ($this->createButtonTxt === null) {
			$this->createButtonTxt = Yii::t('app', 'Добавить комментарий');
		}
		if ($this->cancelButtonText === null) {
			$this->cancelButtonText = Yii::t('app', 'Отмена');
		}
	}
